# Reproducing the simulation results in Appendix E.1
...
Download *Repmain.R*, *DataGen.R*, and *Competing Methods.R* from [here](https://github.com/ninhtran02/ParFilter/tree/main/Simulation) and place it in the "Paper Simulations/Covariate-Assisted" folder. 
