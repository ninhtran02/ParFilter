...
pi1pi1_index = as.numeric(cmd_args[1])
...
pi1pi1 <- pi1pi1_options[pi1pi1_index]
...
for(iter in 1:nsims){
  ...
  data_object <- generate_data_uleqn(m = m, n = n, pi1pi1 = pi1pi1, zeta = zeta)
...
##
if(rho == 0){
  file.name <- paste("Independence/","mu",mu,"setup",u,n,"pi1pi1",pi1pi1,"paral",paral,".RD",sep = "")
} else if(rho > 0){
  file.name <- paste("PositiveDependence/","mu",mu,"setup",u,n,"pi1pi1",pi1pi1,"paral",paral,".RD",sep = "")
} else if(rho < 0){
  file.name <- paste("NegativeDependence/","mu",mu,"setup",u,n,"pi1pi1",pi1pi1,"paral",paral,".RD",sep = "")
}
