...
FDR_dat <- FDR_dat[ !(FDR_dat$Methods %in% c("Adaptive-BH", "BY",
                                            "Inflated-ParFilter", "Non-adaptive-ParFilter")),]
TPR_dat <- TPR_dat[ !(TPR_dat$Methods %in% c("Adaptive-BH", "BY",
                                            "Inflated-ParFilter", "Non-adaptive-ParFilter")),]

rev(10:(10-1+length(methods)))
color_ref <- c(17, 11, # "AdaFilter-BH", "AdaPT"
               #2, # "Adaptive-BH"
               15, # "BH"
               #3, # "BY"
               14, 13, 12, #"CAMT", "IHW", "Inflated-AdaFilter-BH"
               #19, #"Inflated-ParFilter"
...
pdf(file = "u_equal_n_Results_partial.pdf",
...
pdf(file = "u_less_n_Results_partial.pdf",
