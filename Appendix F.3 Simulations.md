...
Download *Repmain_z.R*, *ParFilter functions.R*, and *Data and Oracle z.R* from from [here](https://github.com/ninhtran02/ParFilter/tree/main/Simulation) and place it in the "Paper Simulations/Covariate-Assisted" folder. 
...
7. To run produce the plots, download and run *Plot_z.R* from [here](https://github.com/ninhtran02/ParFilter/tree/main/Simulation).
