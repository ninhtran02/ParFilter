# Reproducing the simulation results in Appendix F.4
...
```
mkdir -p SavedData/PositiveDependencez/
```
...
Download *Repmain_prds.R*, *ParFilter functions.R*, and *Data and Oracle z.R* from [here](https://github.com/ninhtran02/ParFilter/tree/main/Simulation) and place it in the "Paper Simulations/Covariate-Assisted" folder. 
...
6. The resulting data files saved to the subfolders within *Paper Simulation/Covariate-Assisted/SavedData/PositiveDependencez*.
   
7. To produce the plots, download and run *Plot_prds.R* from [here](https://github.com/ninhtran02/ParFilter/tree/main/Simulation).
