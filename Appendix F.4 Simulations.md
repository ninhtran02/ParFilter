...
Download *Repmain_prds.R*, *ParFilter functions.R*, and *Data and Oracle z* from [here](https://github.com/ninhtran02/ParFilter/tree/main/Simulation) and place it in the "Paper Simulations/Covariate-Assisted" folder. 
